...
SECRET_KEY = '2=-3qs54l2i)x0t$&rhvjhx=+vo4a^#lq9##m@7xy=wicj=5mi'
...
# IP адрес, при обращении к которым будет доступен DjDT
INTERNAL_IPS = [
    '127.0.0.1',
]
...
# Подключение бэкенд кеширования
CACHES = {
    'default': {
